...
public class MobileMediaPicker extends AppCompatActivity
{
    private static final String TAG = "MobileMediaPicker";
    ...
    private static MediaPickerCallback _pickerCallback;
    private static String  _tempPathDirectory;

    public static void PickMedia(final MediaPickerCallback callback, String tempPathDirectory, boolean selectImages, boolean selectVideos)
    {
        _pickerCallback    = callback;
        _tempPathDirectory = tempPathDirectory;

        Intent myIntent = new Intent(UnityPlayer.currentActivity, MobileMediaPicker.class);
